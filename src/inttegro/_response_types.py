...
RESPONSE_TYPES_BY_PATH: dict[str, ResponseShape] = {
    ...
    '/prices/activate': _resource(m.CatalogPrice, 'price'), '/prices/archive': _resource(m.CatalogPrice, 'price'), '/prices/create': _resource(m.CatalogPrice, 'price'), '/prices/deactivate': _resource(m.CatalogPrice, 'price'), '/prices/lookup': _resource(m.CatalogPrice, 'price'), '/prices/page': _resource(m.PricePage, 'page'), '/prices/update': _resource(m.CatalogPrice, 'price'),
    '/products/add_price': _resource(m.CatalogPrice, 'price'), '/products/archive': _resource(m.Product, 'product'), '/products/create': _resource(m.Product, 'product'), '/products/lookup': _resource(m.Product, 'product'),
