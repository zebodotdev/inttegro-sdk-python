"""CurrencySnapshotRefund in the ``inttegro.balance`` resource namespace.
...
class CurrencySnapshotRefund(ApiModel):
    ...
    API contract schema: ``CurrencyBalanceSnapshotRefund``.
    """
