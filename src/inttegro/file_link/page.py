"""Page in the ``inttegro.file_link`` resource namespace.
...
class Page(ApiModel):
    ...
    API contract schema: ``FileLinkPage``.
    """
    ...
    """The file links associated with this page. Required. Python type: ``list[FileLink]``; wire name: ``file_links``; JSON type: array of object (FileLinkObject) values"""
