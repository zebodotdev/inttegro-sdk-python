"""Actor in the ``inttegro.file_link`` resource namespace.
...
class Actor(ApiModel):
    """Typed actor data in the file link resource namespace.
    ...
    API contract schema: ``FileLinkActor``.
    """
    email: str | None = field(init=False)
    """The email associated with this actor. Optional; nullable. Python type: ``str | None``; wire name: ``email``; JSON type: string (email)"""
