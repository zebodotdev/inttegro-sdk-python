"""Kind in the ``inttegro.file_link`` resource namespace.
...
class Kind(WireEnum):
    """Typed kind data in the file link resource namespace.
    ...
    API contract schema: ``FileLinkKind``.
    """
    PUBLIC = "public"
    """Wire value ``public`` (public)"""
