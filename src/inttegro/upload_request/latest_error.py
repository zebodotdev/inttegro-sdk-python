"""LatestError in the ``inttegro.upload_request`` resource namespace.
...
class LatestError(ApiModel):
    """Typed latest error data in the upload request resource namespace.
    ...
    API contract schema: ``UploadRequestLatestError``.
    """
    ...
    """The param associated with this latest error. Optional; nullable. Python type: ``str | None``; wire name: ``param``; JSON type: string"""
