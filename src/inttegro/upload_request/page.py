"""Page in the ``inttegro.upload_request`` resource namespace.
...
class Page(ApiModel):
    ...
    API contract schema: ``UploadRequestPage``.
    """
    ...
    """The upload requests associated with this page. Required. Python type: ``list[UploadRequest]``; wire name: ``upload_requests``; JSON type: array of object (UploadRequestObject) values"""
