"""Response in the ``inttegro.product`` resource namespace.
...
class Response(ApiModel):
    ...
    API contract schema: ``ProductResponse``.
    """
    product: Product | None = field(init=False)
    """The product associated with this response. Optional; nullable. Python type: ``Product | None``; wire name: ``product``; JSON type: object (Product)"""
