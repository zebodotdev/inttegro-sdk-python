"""PaymentMethodGhanaBankAccount in the ``inttegro.payment`` resource namespace.
...
class PaymentMethodGhanaBankAccount(ApiModel):
    ...
    API contract schema: ``PaymentMethodSnapshotGhanaBankAccount``.
    """
