"""VariableType in the ``inttegro.message_template`` resource namespace.
...
class VariableType(WireEnum):
    """Typed variable type data in the message template resource namespace.
    ...
    API contract schema: ``MessageTemplateVariableType``.
    """
    STRING = "string"
