"""CancelDetail in the ``inttegro.broadcast`` resource namespace.
...
class CancelDetail(ApiModel):
    """Typed cancel detail data in the broadcast resource namespace.
    ...
    API contract schema: ``BroadcastCancelDetail``.
    """
    ...
    """The errors associated with this cancel detail. Optional; nullable. Python type: ``list[BroadcastError] | None``; wire name: ``errors``; JSON type: array of object (BroadcastError) values"""
