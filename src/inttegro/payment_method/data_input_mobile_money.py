"""DataInputMobileMoney in the ``inttegro.payment_method`` resource namespace.
...
class DataInputMobileMoney(ApiRequest):
    ...
    API contract schema: ``PaymentMethodDataInputMobileMoney``.
    """
