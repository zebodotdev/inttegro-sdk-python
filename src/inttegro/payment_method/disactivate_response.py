"""DisactivateResponse in the ``inttegro.payment_method`` resource namespace.
...
class DisactivateResponse(ApiModel):
    ...
    API contract schema: ``DisactivatePaymentMethodResponse``.
    """
