"""CreationDetail in the ``inttegro.schedule`` resource namespace.
...
class CreationDetail(ApiModel):
    """Typed creation detail data in the schedule resource namespace.
    ...
    API contract schema: ``ScheduleCreationDetail``.
    """
    ...
    """When execution of the creation detail began. Optional; nullable. Python type: ``datetime | None``; wire name: ``executed_at``; JSON type: string (date-time)"""
    full_message: str = field(init=False)
    """The full message associated with this creation detail. Required. Python type: ``str``; wire name: ``full_message``; JSON type: string"""
    ...
    """The recipients associated with this creation detail. Optional; nullable. Python type: ``list[str] | None``; wire name: ``recipients``; JSON type: array of string values"""
