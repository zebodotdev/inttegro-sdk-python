"""PageResponse in the ``inttegro.price`` resource namespace.
...
class PageResponse(ApiModel):
    ...
    API contract schema: ``PricePageResponse``.
    """
    page: PricePage | None = field(init=False)
    """Numeric page used by this operation. Optional; nullable. Python type: ``PricePage | None``; wire name: ``page``; JSON type: object"""
