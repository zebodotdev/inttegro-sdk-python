...
class AsyncPaymentMethods:
    ...
    async def tokenize(self, payload: dict):
        """
        ...
        """
        return await self.http.post('/payment_methods/tokenize', payload)

    async def verify(self, payment_method_id: str, request_meta: dict | None=None):
        """
        ...
        See Also:
            ...
            - https://studio.inttegro.com/charge-repeat-customers
        """
        return await self.http.post('/payment_methods/verify', {'payment_method_id': payment_method_id, 'request_meta': request_meta or _stable_payment_method_request_meta('verify', payment_method_id)})

    async def confirm_verification(self, payload: dict):
        """
        ...
        See Also:
            ...
            - https://studio.inttegro.com/charge-repeat-customers
        """
        return await self.http.post('/payment_methods/confirm_verification', payload)

    async def lookup(self, payment_method_id: str):
        """
        ...
        """
        return await self.http.post('/payment_methods/lookup', {'payment_method_id': payment_method_id})
    ...
    async def page(self, payload: dict | None=None):
        ...
        """
        return await self.http.post('/payment_methods/page', payload or {})
    ...
    async def update(self, payload: dict):
        ...
        """
        return await self.http.post('/payment_methods/update', payload)

    async def activate(self, payment_method_id: str):
        ...
        """
        return await self.http.post('/payment_methods/activate', {'payment_method_id': payment_method_id})

    async def disactivate(self, payment_method_id: str):
        ...
        Raises:
            ...
            TimeoutError: The configured request deadline elapsed.
        """
        return await self.http.post('/payment_methods/disactivate', {'payment_method_id': payment_method_id})

    async def deactivate(self, payment_method_id: str):
        ...
        Returns:
            ``PaymentMethod`` decoded from the documented response shape.
        """
        return await self.disactivate(payment_method_id)

    async def archive(self, payment_method_id: str):
        ...
        Raises:
            ...
            TimeoutError: The configured request deadline elapsed.
        """
        return await self.http.post('/payment_methods/archive', {'payment_method_id': payment_method_id})

    async def unarchive(self, payment_method_id: str):
        ...
        Raises:
            ...
            TimeoutError: The configured request deadline elapsed.
        """
        return await self.http.post('/payment_methods/unarchive', {'payment_method_id': payment_method_id})

    async def delete(self, payment_method_id: str, request_meta: dict | None=None):
        """
        ...
        """
        return await self.http.post('/payment_methods/delete', {'payment_method_id': payment_method_id, 'request_meta': request_meta or _stable_payment_method_request_meta('delete', payment_method_id)})
    ...
    async def settings(self):
        ...
        """
        return await self.http.post('/payment_methods/settings', {})
