...
class AsyncPayouts:
    ...
    async def lookup(self, payout_id: str):
        """
    ...
    async def disable_automatic(self):
        """
    ...
    async def enable_automatic(self):
        """
    ...
    async def page(self, payload: dict | None=None):
        ...
        """
        return await self.http.post('/payouts/page', payload or {})

    async def cancel(self, payout_id: str):
        """
