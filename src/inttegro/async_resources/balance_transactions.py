...
class AsyncBalanceTransactions:
    ...
    async def lookup(self, transaction_id: str):
        """
        ...
        """
        return await self.http.post('/balance_transactions/lookup', {'transaction_id': transaction_id})
    ...
    async def page(self, payload: dict | None=None):
        ...
        """
        return await self.http.post('/balance_transactions/page', payload or {})
