...
class AsyncOtp:
    ...
    async def initiate(self, payload: dict):
        """
        ...
        """
        return await self.http.post('/otp/initiate', payload)
    ...
    async def verify(self, payload: dict):
        ...
        """
        return await self.http.post('/otp/verify', payload)
    ...
    async def lookup(self, payload: dict):
        ...
        """
        return await self.http.post('/otp/lookup', payload)

    async def cancel(self, payload: dict):
        """
        ...
        """
        return await self.http.post('/otp/cancel', payload)
