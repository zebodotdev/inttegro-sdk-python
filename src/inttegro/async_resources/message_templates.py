...
class AsyncMessageTemplates:
    ...
    Access this service as ``AsyncInttegroClient.message_templates``. Methods use the client's shared transport and return the typed resource shapes documented below.
    """
