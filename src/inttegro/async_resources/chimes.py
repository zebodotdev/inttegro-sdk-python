...
class AsyncChimes:
    ...
    async def send(self, payload: dict):
        ...
        """
        return await self.http.post('/chimes/send', payload)

    async def lookup(self, chime_id: str):
        """
        ...
        """
        return await self.http.post('/chimes/lookup', {'chime_id': chime_id})
    ...
    async def page(self, payload: dict | None=None):
        ...
        """
        return await self.http.post('/chimes/page', payload or {})

    async def schedule(self, payload: dict):
        """
        ...
        """
        return await self.http.post('/chimes/schedule', payload)
    ...
    async def broadcast(self, payload: dict):
        ...
        """
        return await self.http.post('/chimes/broadcast', payload)
