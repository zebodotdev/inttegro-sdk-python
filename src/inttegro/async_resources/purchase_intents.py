...
class AsyncPurchaseIntents:
    ...
    Access this service as ``AsyncInttegroClient.purchase_intents``. Methods use the client's shared transport and return the typed resource shapes documented below.
    """
