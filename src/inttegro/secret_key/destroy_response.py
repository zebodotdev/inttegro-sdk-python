"""DestroyResponse in the ``inttegro.secret_key`` resource namespace.
...
class DestroyResponse(ApiModel):
    """Typed response returned by the destroy operation.
    ...
    API contract schema: ``DestroySecretKeyResponse``.
    """
