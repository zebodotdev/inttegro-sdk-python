"""CreateNewCustomerInputRequestMeta in the ``inttegro.order`` resource namespace.
...
class CreateNewCustomerInputRequestMeta(ApiRequest):
    ...
    API contract schema: ``CreateOrderNewCustomerInputRequestMeta``.
    """
