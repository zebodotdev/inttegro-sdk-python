"""CompleteEnvelope in the ``inttegro.order`` resource namespace.
...
class CompleteEnvelope(ApiModel):
    """Typed complete envelope data in the order resource namespace.
    ...
    API contract schema: ``CompleteOrderEnvelope``.
    """
