"""DocumentDeliveryAttempt in the ``inttegro.order`` resource namespace.
...
class DocumentDeliveryAttempt(ApiModel):
    ...
    API contract schema: ``OrderDocumentDeliveryAttempt``.
    """
    ...
    """Chime ID created for this delivery. Optional; nullable. Python type: ``str | None``; wire name: ``chime_id``; JSON type: string"""
