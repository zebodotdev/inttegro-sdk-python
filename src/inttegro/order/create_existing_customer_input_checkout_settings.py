"""CreateExistingCustomerInputCheckoutSettings in the ``inttegro.order`` resource namespace.
...
class CreateExistingCustomerInputCheckoutSettings(ApiRequest):
    ...
    API contract schema: ``CreateOrderExistingCustomerInputCheckoutSettings``.
    """
