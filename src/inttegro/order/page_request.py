"""PageRequest in the ``inttegro.order`` resource namespace.
...
class PageRequest(ApiRequest):
    ...
    API contract schema: ``PageOrdersRequest``.
    """
    ...
    page_size: int
    """Number of payment methods per page (1-256). Required. Python type: ``int``; wire name: ``page_size``; JSON type: integer. Constraints: minimum 1; maximum 256"""
