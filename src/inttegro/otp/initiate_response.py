"""InitiateResponse in the ``inttegro.otp`` resource namespace.
...
class InitiateResponse(ApiModel):
    """Typed response returned by the initiate operation.
    ...
    API contract schema: ``InitiateOTPResponse``.
    """
